...
docker save imesh/wso2-microservices-poc-customers-service:0.2 > customers-service-0.2.tar

echo "Saving credits service docker image..."
docker save imesh/wso2-microservices-poc-credits-service:0.2 > credits-service-0.2.tar

echo "Saving loans service docker image..."
docker save imesh/wso2-microservices-poc-loans-service:0.2 > loans-service-0.2.tar

echo "Saving loan applications service docker image..."
docker save imesh/wso2-microservices-poc-loan-applications-service:0.2 > loan-applications-0.2.tar
